...
from core.security import get_current_user  # returns current User object
...
def create_order(
    ...
    # Readable order number e.g. ORD-20260503-A1B2C3
    ...
    # Store razorpay_order_id in note field temporarily
    # Add a proper razorpay_order_id column via migration when convenient
